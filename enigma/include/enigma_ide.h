...
int __declspec(dllimport) __stdcall EP_RegEncryptRegistrationInformation(const char* ABuffer, int* ABufferSize, const char* ARegName, int ARegNameLen, const char* ARegKey, int ARegKeyLen);
int __declspec(dllimport) __stdcall EP_RegDecryptRegistrationInformation(const char* ABuffer, int ABufferSize, const char* ARegName, int* ARegNameLen, const char* ARegKey, int* ARegKeyLen);
...
BOOL __declspec(dllimport) __stdcall EP_ActivationDeactivate();
BOOL __declspec(dllimport) __stdcall EP_ActivationDeactivateWithId(const char* ActivationId);
BOOL __declspec(dllimport) __stdcall EP_ActivationDeactivateWithIdA(const char* ActivationId);
BOOL __declspec(dllimport) __stdcall EP_ActivationDeactivateWithIdW(const wchar_t* ActivationId);
...
// Crypt API
int __declspec(dllimport) __stdcall EP_CryptHashBuffer( int Hash, const char* Buffer, int Size, const char* Digest);
int __declspec(dllimport) __stdcall EP_CryptHashFileA( int Hash, const char* FileName, const char* Digest);
int __declspec(dllimport) __stdcall EP_CryptHashFileW( int Hash, const wchar_t* FileName, const char* Digest);
int __declspec(dllimport) __stdcall EP_CryptHashStringA( int Hash, const char* Str, const char* Digest);
int __declspec(dllimport) __stdcall EP_CryptHashStringW( int Hash, const wchar_t* Str, const char* Digest);
void __declspec(dllimport) __stdcall EP_CryptEncryptBuffer( const char* Buffer, int Size, const char* Key);
void __declspec(dllimport) __stdcall EP_CryptEncryptBufferEx( const char* InBuffer, const char* OutBuffer, int Size, const char* Key, int KeySize);
void __declspec(dllimport) __stdcall EP_CryptDecryptBuffer( const char* Buffer, int Size, const char* Key);
void __declspec(dllimport) __stdcall EP_CryptDecryptBufferEx( const char* InBuffer, const char* OutBuffer, int Size, const char* Key, int KeySize);
...
BOOL __declspec(dllimport) __stdcall EP_CheckupFindProcess(const char* FileName, const char* WindowText, const char* WindowClass);
BOOL __declspec(dllimport) __stdcall EP_CheckupFindProcessA(const char* FileName, const char* WindowText, const char* WindowClass);
BOOL __declspec(dllimport) __stdcall EP_CheckupFindProcessW(const wchar_t* FileName, const wchar_t* WindowText, const wchar_t* WindowClass);
